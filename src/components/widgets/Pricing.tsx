...
const Pricing = ({ header, prices }: PricingProps) => (
  <section className="bg-primary-50 " id="pricing">
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
      {header && <HeaderWidget header={header} titleClassname="text-2xl sm:text-3xl" />}
      <div className="flex items-stretch justify-center align-middle">
        <div className="grid grid-cols-1 gap-3  sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1">
          ...
          {prices.map(({ title, value, period, texts, callToAction, hasRibbon, ribbonTitle }, index) => (
            <div
              className="col-span-1 mx-auto flex w-full sm:col-span-1 md:col-span-1 lg:col-span-1 xl:col-span-1"
            ...
            >
              <div className="card relative flex w-full max-w-sm flex-col justify-between text-center">
                ...
                <ul className="px-2 py-0">
                  <li className="text-center text-xl font-medium uppercase leading-6 tracking-wider text-gray-800 ">
                    {title}
                  </li>
                  ...
                  <li className="mb-7 text-center text-base font-medium capitalize leading-6 text-gray-600 ">
                    {period}
                  </li>
                  {texts &&
                ...
                {callToAction && <CTA data={callToAction as CallToAction} class={`btn-primary mt-8`} />}
              </div>
            </div>
          ))}
        </div>
